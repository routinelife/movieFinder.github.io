...
var MovieFinder = function (_React$Component) {
  ...
  _createClass(MovieFinder, [{
    ...
    value: function handleSubmit(event) {
      ...
      var searchTerm = this.state.searchTerm; // E6 destructuring
      ...
      fetch("https://www.omdbapi.com/?s=" + searchTerm + "&apikey=bf757cd7").then(checkStatus).then(json).then(function (data) {
